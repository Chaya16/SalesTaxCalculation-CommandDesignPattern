...
/**
 * Write a description of class HeadachePill here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class HeadachePill extends Item
{
   ...
   ProductDecoratorInterface pdi;
    ...
    /**
     * Constructor for objects of class HeadachePill
     */
    public HeadachePill(ProductDecoratorInterface pdi)
    {
        this.pdi = pdi;
    }
